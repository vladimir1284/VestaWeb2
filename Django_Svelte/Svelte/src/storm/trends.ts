import { currentRadar, current_datetime, mapProj, storms, layers } from "../store";
...
export function updateTrendVisibility(storms: Storm[]) {
  ...
  try {
    if (Object.keys(features).length !== 0) {
      storms.forEach(function (storm: Storm) {
        const show_past =
